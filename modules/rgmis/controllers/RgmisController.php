...
class RgmisController extends \yii\web\Controller
{
    ...
    public function actionGrantstatus($yr='')
    {
...
//            print_r($y);exit;
		...
		$dt = RGMIS::GET_RECEIVED_GRANT($yr);
		return $this->render('collegegrantstatus',['data'=>$dt,'yr'=>$yr,'range'=>1]);
	...
	public function actionAnnualgrants()
    {
		$dt = RGMIS::GET_GRANTINCOMECOMPARISON();
		return $this->render('annualgrants',['data'=>$dt]);
    }
	public function actionAnnualadmincosts()
    {
		$dt = RGMIS::GET_GRANTINCOMECOMPARISON();
		return $this->render('annualadmincosts',['data'=>$dt]);
    }
