...
// yii\helpers\Url
   ...
   // $result = $dbhandle->query($strQuery) or exit("Error code ({$dbhandle->errno}): {$dbhandle->error}");
    ...
    // If the query returns a valid response, prepare the JSON string
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "UNIVERSITY TOTAL ANNUAL GRANTS ADMIN COSTS COMPARATIVE ANALYSIS",
              ...
              "divlineColor" => "#2bb9cf",
              "divLineIsDashed" => "1",
			  "yAxisName"=> "ADMIN COST AMOUNT IN KSH.",
			  "xAxisName"=> "YEAR",
			  "numberSuffix"=> "",
			   "exportEnabled"=>"1",
              ...
              "bgColor" => "#ffffff",
			   ...
			   "exportFileName"=>"AnnualAdminCosts",
...
//"value" => number_format(($strsarr2[0]/$col_total)*100,2)
            //"value" => number_format(($k["TOTAL_OVERHEAD_AMOUNT"])/1000000,2)
...
<h4 class="text-center"><?php echo "UNIVERSITY TOTAL ANNUAL GRANTS COMPARATIVE ANALYSIS ".$gtitle;?></h4>
<p>
<style>
