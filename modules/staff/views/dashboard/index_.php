...
?>
<!-- 
<div class="row" style="overflow-y:scroll;white-space: nowrap;">
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        ...
                        <div>Staff retiring this year!</div>
                    </div>
                </div>
            </div>
            <a href="#">
...
<div class="row">
    <div class="col-lg-8">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-bar-chart-o fa-fw"></i> Staff Exit per year
            </div>
            <!-- /.panel-heading -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-bar-chart-o fa-fw"></i> Performance Apraisal Status per College
