	...
	<table class="table table-bordered table-hover table-striped table-nonfluid">
		...
		?>
			<tr style="font-weight: bold;<?=$bc?>">
				...
				<td class="text-right"> <?= $k["MALE"]?$k["MALE"]:'<span style="color:red;">0</span>' ?></td>
				<td class="text-right"> <?= $k["FEMALE"]?$k["FEMALE"]:'<span style="color:red;">0</span>' ?></td>
			</tr>
			<?php
		}
		?>
		...
		<tfoot>
			...
			<th class="text-right"><?=$sumMl?></th>
			<th class="text-right"><?=$sumFMl?></th>
			</tr>
			<tr>
			<th class="text-center text-primary">GRAND TOTAL</th>
			<th class="text-right" colspan=2><?=$sumMl+$sumFMl?></th>
			</tr>
		</tfoot>
	</table>
	</div>
