...
$dt2 = \app\modules\transmis\models\RGMIS::GET_GRANTINCOME();
$dt = \app\modules\transmis\models\RGMIS::GET_RECEIVED_GRANT();
?>
...
<div class="row">
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?= $this->render('@app/modules/transmis/views/transmis/collegegrantstatus', ['data' => $dt]); ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?= $this->render('@app/modules/transmis/views/transmis/collegegrantstatusuni', ['data' => $dt2]); ?>
            </div>
        </div>
    </div>
</div>
